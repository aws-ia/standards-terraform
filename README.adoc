...
> NOTE: This program is in Aplha and such the recommendation are updated often. Please be sure to refer to this document often to keep updated!

For FAQ please refer to https://faq.aws-ia.github.io/
...
# Use baseline VPC from aws-ia registry
module "workload_vpc" {
